...
При недоступности API вызывает исключение см. [oшибка валидации](#oшибка_валидации).
...
<details>
  ...
  <summary>Общие исключения</summary>

- <span id="oшибка_валидации">Ошибка валидации</span>, статус код 422:
