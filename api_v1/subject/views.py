...
@router.post('/create_subject', dependencies=[Depends(current_user.superuser)])
...
@router.delete('/delete_subject/{subject_name}', dependencies=[Depends(current_user.superuser)])
